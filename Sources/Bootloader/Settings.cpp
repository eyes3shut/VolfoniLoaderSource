...
Settings::Settings(QWidget *parent, bool AppMode) :
    QDialog(parent,Qt::WindowCloseButtonHint),
    m_ui(new Ui::Settings)
{
    m_ui->setupUi(this);
    if(AppMode==false)m_ui->DebugActivatedCheckBox->setEnabled(false);
...
void Settings::setActivatedDebug(bool value)
{
    ActivatedDebug = value;
    m_ui->DebugActivatedCheckBox->setChecked(value);
}
...
void Settings::on_buttonBox_accepted()
{
    ...
    ActivatedDebug = m_ui->DebugActivatedCheckBox->isChecked();
}
